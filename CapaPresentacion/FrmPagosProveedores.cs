...
namespace CapaPresentacion
{
    public partial class FrmPagosProveedores : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult confirm = MessageBox.Show("¿Está seguro de eliminar este pago?", "Confirmar eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void dgvPagosProveedores_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
