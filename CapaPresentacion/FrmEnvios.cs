...
namespace CapaPresentacion
{
    public partial class FrmEnvios : KryptonForm
    {
        ...
        private void FrmEnvios_Load(object sender, EventArgs e)
        {
            MtdCargarVentas(); 
            MtdCargarEnvios();
            dgvEnvios.CellClick += dgvEnvios_CellContentClick;
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var confirm = MessageBox.Show("¿Seguro que desea eliminar este envío?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);

                if (confirm == DialogResult.Yes)
                {
                    cd_envios.MtdEliminarEnvios(codigoEnvio);
                    MessageBox.Show("Envío eliminado correctamente.", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LimpiarCampos();
                    MtdCargarEnvios();
                }
            }
            ...
            {
                MessageBox.Show("Error al eliminar el envío: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
