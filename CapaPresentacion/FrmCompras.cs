...
namespace CapaPresentacion
{
    public partial class FrmCompras : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txtCodigoCompra.Text))
            {
                MessageBox.Show("Seleccione una compra para eliminar.", "Atención", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            DialogResult resultado = MessageBox.Show("¿Está seguro de eliminar esta compra?",
