...
namespace CapaPresentacion
{
    public partial class Frmproductos : KryptonForm
    {
       ...
       CDproductos cd_producto =new CDproductos();
        ...
        {
            if (string.IsNullOrEmpty(cboxCodigoDetalleVenta.Text) || string.IsNullOrEmpty(cboxCodigoBarra.Text) || string.IsNullOrEmpty(txtNombreProducto.Text) || string.IsNullOrEmpty(txtPrecio.Text) ||
             string.IsNullOrEmpty(txtCategoria.Text) || string.IsNullOrEmpty(txtStock.Text) || string.IsNullOrEmpty(dtpfecha.Text) || string.IsNullOrEmpty(cboxEstado.Text))
            {
            ...
            else
            {
                try
                {
                    ...
                    string CodigoBarra = cboxCodigoBarra.Text;
        ...
        private void dvgproductos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                cboxCodigoBarra.Text = dgvProductos.CurrentRow.Cells[2].Value.ToString();
