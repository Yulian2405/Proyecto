...
namespace CapaDatos
{
    public class CDpagosclientes
    {
        ...
        public void MtdAgregarPagoClientes (int CodigoPago, int CodigoEnvio, DateTime Fecha, decimal Monto, string MetodoPago, string ReferenciaPago, string Estado)
        {
            string Query = @"INSERT INTO tbl_pagosClientes 
                             (CodigoPago, CodigoEnvio, Fecha, Monto, MetodoPago, ReferenciaPago, Estado)
                             VALUES (@CodigoPago, @CodigoEnvio, @Fecha, @Monto, @MetodoPago, @ReferenciaPago, @Estado);";
        ...
        public void MtdEditarPagosClientes (int CodigoPago, int CodigoEnvio, DateTime Fecha, decimal Monto, string MetodoPago, string ReferenciaPago, string Estado)
        {
            string Query = @"UPDATE tbl_pagosClientes
